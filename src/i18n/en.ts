const en = {
  ...
  mip7: {
    ...
    collisionProb: {
      ...
      step1: "Ethereum execution-layer hard forks since Homestead (BPO, difficulty-bomb-only, and consensus-only forks excluded)",
      ...
      stage_a: "Published on EIPs page + Ethereum Magicians",
      stage_b: "Introduced on an All Core Devs call",
      stage_c: "0xAE blocked off in ethereum-specs (pending + proposed)",
      stage_d: "Spec tests + 0xAE placeholder in ethereum-specs",
      stage_e: "Officially committed (in a hard fork or embedded in history)",
      currentStage: "current",
      stagesNote:
        "Working assumption: each successive stage cuts the probability that EIP-8163 is not upheld by roughly 10×. The multipliers are illustrative estimates of growing social and technical commitment. The final stage snaps to zero - once the reservation lands in a deployed Ethereum hard fork, collision becomes impossible.",
      yearlyConflict: "Yearly conflict probability",
      formulaIntro: "Probability that any new Ethereum opcode hits one of the N custom slots:",
      formulaIntroMip7:
        "MIP-7 always contributes a single shared slot (0xAE) regardless of how many extensions live behind it. The risk reduces to: did Ethereum break the EIP-8163 reservation?",
      stageShort: "stage",
      perYearProb: "Per year",
      tenYearProb: "Over 10 years",
      tenYearNote: "P(at least one conflict in 10 yearly draws)",
      lotteryPrefix: "≈ 1 in ",
      lotterySuffix: " yearly draw",
      zeroChance: "Reservation is set in stone",
      ticketStripLabel: "Cumulative collision risk by year",
      ticketStripFootnote:
        "Each bar shows the cumulative probability of at least one collision by the end of that year. The yearly odds compound across the timeframe.",
    },
    namespace: {
