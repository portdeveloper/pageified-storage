const en = {
  ...
  mip7: {
    ...
    collisionProb: {
      ...
      stage_c: "0xAE blocked off in ethereum-specs",
      ...
      sliderNote:
        "EIP-8163 is currently published and proposed, ahead of any official inclusion. At this stage its visibility is already enough to make it a reasonable foundation for introducing opcodes today. Use the slider to dial in your own confidence in the reservation holding, and watch how that flows into the collision math.",
