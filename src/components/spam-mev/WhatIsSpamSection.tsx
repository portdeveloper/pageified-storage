    ...
    <section ref={ref} className="py-24 px-6 bg-surface-alt relative">
      ...
      >
        ...
        <p className="text-lg text-text-secondary font-light max-w-3xl leading-relaxed mb-12">
          Traditional MEV identifies opportunities off-chain and submits precise
          transactions. Spam MEV floods the chain with speculative probes whose
          profitability is resolved only at execution time.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="bg-user-bg rounded-xl border border-user-cell p-6">
            ...
            <FlowDiagram
              steps={[
                {
                  label: "Searcher monitors mempool",
                  bg: "#d4e4f4",
                  color: "#3b7dd8",
                },
                {
          ...
          <div className="bg-problem-bg rounded-xl border border-problem-cell-hover p-6">
            ...
            <FlowDiagram
              steps={[
                {
                  label: "Searcher floods chain with probes",
                  bg: "#f0d0c0",
                  color: "#c4653a",
                },
                {
                  label: "All probes run on-chain",
                  bg: "#f0d0c0",
                  color: "#c4653a",
                },
                {
                  label: "Each checks: opportunity exists?",
                  bg: "#e8b8a8",
                  color: "#a04828",
                },
                {
                  label: "Most revert or find nothing",
                  bg: "#f0d0c0",
                  color: "#c4653a",
                },
              ]}
              result="6-12% success rate"
              resultColor="#c4653a"
            />
            <p className="font-mono text-[11px] text-text-tertiary mt-4 text-center">
